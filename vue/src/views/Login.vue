<template>
  <div class="wrapper">
    <div style="height: 60px; line-height: 60px; font-size: 20px; padding-left: 50px; color: white;
      background-color: rgba(0,0,0,0.2)">欢迎登录景区线上订票系统</div>

    <div style="margin-left: 520px; margin-top: 170px; background-color: rgba(0, 0, 0, 0.2); width: 350px; height: 350px; padding: 20px; border-radius: 10px">
      <div style="margin: 20px 0; text-align: center; font-size: 24px; color:#d9d9d9"><b>系 统 登 录</b></div>
...
<!--        </el-form-item>-->
        <el-form-item>
          <el-button style="width: 100%;" type="primary" size="small"  autocomplete="off" @click="login">登 录</el-button>
        </el-form-item>
        ...
        <div style="display: flex; align-items: center">
          ...
          <div style="flex: 1; text-align: right">
            还没有账号？请 <a href="/register" style="color: white">注册</a>
          </div>
        </div>
